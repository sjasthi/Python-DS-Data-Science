...
# Week 25 Lab: HTML for Data Scientists
...
## Exercise 1: My First HTML Page (Basic Structure)
...
## Exercise 2: Lists (Ordered and Unordered)
...
**Challenge:** Add a **nested list** — put a `<ul>` inside one of the `<li>` items. For example, under "School Supplies" you could nest "Pencils", "Erasers", "Highlighters".

---

## Exercise 3: Build a Data Table
...
## Exercise 4: Div Containers with Classes and IDs
...
**Think Like a Scraper:** After building this, answer these questions:
...
## Exercise 5: Reading Real HTML (View Source)
...
## Exercise 6: Inspect Element Practice
...
## Exercise 7: Fix the Broken HTML
...
## Bonus Challenge: Build a Page That's Ready to Scrape
...
Complete Exercises 1–6 and at least attempt Exercise 7. For each exercise, paste your HTML code into the online editor, verify it works, and save your answers.
